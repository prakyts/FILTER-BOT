...
auth_channel = environ.get('AUTH_CHANNEL', '-1001995573762') # give your force subscribe channel id here else leave it blank
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'a9888b6ac5240acb62f943b5edda8c660158a8a1')
